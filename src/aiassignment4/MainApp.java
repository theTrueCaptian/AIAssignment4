...
public class MainApp {
    ...
    public void start(){
        ...
        System.out.println("Enter in growth strategy:");
        Scanner scan3 = new Scanner(System.in);
        String strategy = scan3.nextLine();
        
        //initialize tree
         GPgenerate(root, 0, strategy, maxTreeHeight);
    }

    public void GPgenerate(Node gpTree, int nodeIndex, String growthStrategy, int maxTreeHeight){
    ...
    public Node grow(int depth){
        ...
        if(depth<maxTreeHeight-1){
            if(depth!=0){
                ...
                //remove this node from the lists
    ...
    public Node random(ArrayList<Node> in){
        System.out.println("Take a char from the following:");
        ...
        System.out.println("chosen char:"+in.get(index).getData());
        return in.get(index);
